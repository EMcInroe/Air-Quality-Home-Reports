---
title: "ASPIRE Air Quality Plots"
...
setwd("O:/PRIV/IRBData/AspireHealthTulare")
load("Data/Air_quality_stats/all_data_20240405.Rdata")
names(all_data)

pa_data<-fread("Data/Air_quality_stats/terra_bella_pa.txt", fill = TRUE, header = TRUE)
names(pa_data)
...
## treatment groups
treat_schedule<-fread("O:\\PRIV\\IRBData\\AspireHealthTulare\\Data\\Survey Data\\treatment_schedule.csv", drop = 3:27)

## intervention period by household
part_start_end<-fread("Participant tracking/participant_start_end_dates.csv", header = T)
...
ozone_df<-fread("O:\\PRIV\\IRBData\\AspireHealthTulare\\Analysis\\Air Quality Analysis\\Daily_Ozone_Porterville_2023.csv", header = T)
...
```{r linear fits}
# PurpleAir correlation to Porterville AirNow
...
# BlueSky correlation to Porterville AirNow
...
# BlueSky correlation to Porterville T640
...
# BlueSky correlation to PurpleAir in Terra Bella
...
#png("O:/PRIV/IRBData/AspireHealthTulare/Analysis/Air Quality Analysis/home_reports_plots/Calendar_plots/intervent_prd_outdoorpm25_calendarplot.png")
...
pdf("O:/PRIV/IRBData/AspireHealthTulare/Analysis/Air Quality Analysis/home_reports_plots/Calendar_plots/calendarplot_eng_wnumeric_v2.pdf")
    #width = 1400,
#     height = 1200)
...
pdf("O:/PRIV/IRBData/AspireHealthTulare/Analysis/Air Quality Analysis/home_reports_plots/Calendar_plots/intervent_prd_outdoorpm25_spanish_calendarplot.pdf")
cal_plot<-calendarPlot(intervention_pm25, 
             year=2023,
             pollutant="pm2_5_bluesky_cor",
             labels=labels,
...
treat_schedule$treatment<-ifelse(treat_schedule$house_ID=="H37", "C",treat_schedule$treatment)
treat_schedule$house_ID_treat<-NULL

ambass_houses<-c("H20","H21","H22")
...
no_power<-c("R26","R30","R56","R57",unique(all_data$room_id[which(all_data$treatment=="Control")]))
wrong_power<-c("R05","R16")
no_indoor_above<-c("R14","R16","R22","R49","R54","R55")
...
start_date<-"2023-10-09 19:00:00 PDT"
end_date<-"2023-10-23 14:00:00 PDT"
...
# png(paste0("O:/PRIV/IRBData/AspireHealthTulare/Analysis/Air Quality Analysis/home_reports_plots/indoor_outdoor_pm25_byroom/",room,"_indr_outdr_AQ_plot.png"),
...
if(room %in% wrong_power) {
  start_date<-"2023-10-08 00:00:00 UCT"
  end_date<-"2023-10-21 02:00:00 UCT"
...
intervention_pm25<-subset(all_data, date>="2023-10-07")

# no_power<-c("R26","R30","R56","R57",unique(all_data$room_id[which(all_data$treatment=="Control")]))
# wrong_power<-c("R05","R16")
no_indoor_above<-c("R14","R16","R22","R49","R54","R55")
no_indoor_pm<-c("R33","R35","R36","R38","R41","R45","R48","R56")
...
for(i in seq(room_id_list)) {
  ...
  if(room %in% no_indoor_pm) {
    enddate<-"2023-10-23 02:00:00 UCT"
  }else {
...
png(paste0("O:/PRIV/IRBData/AspireHealthTulare/Analysis/Air Quality Analysis/home_reports_plots/indoor_outdoor_pm25_byroom/",house,"/",room,"_indr_peak_plot.png"),
    width=1200, height = 900)

# png(paste0("O:/PRIV/IRBData/AspireHealthTulare/Analysis/Air Quality Analysis/home_reports_plots/indoor_outdoor_pm25_byroom/",room,"_indr_peak_plot.png"),
#     width=1200, height = 900)
...
png(paste0("O:/PRIV/IRBData/AspireHealthTulare/Analysis/Air Quality Analysis/home_reports_plots/indoor_outdoor_pm25_byroom/",house,"/",room,"_indr__snippet_peak_plot.png"),
...
no_power<-c("R26","R30","R56","R57",unique(all_data$room_id[which(all_data$treatment=="Control")]), no_indoor_pm)
#wrong_power<-c("R05","R16")
...
if(room %in% wrong_power) {
  ...
  plot_df_power<-subset(all_data, date>="2023-10-08 00:00:00 UCT" & room_id ==room)
  # start_date<-"2023-10-08 00:00:00 UCT"
  # end_date<-"2023-10-21 02:00:00 UCT"
...
png(paste0("O:/PRIV/IRBData/AspireHealthTulare/Analysis/Air Quality Analysis/home_reports_plots/indoor_outdoor_pm25_byroom/",house,"/",room,"_indr_filter_plot.png"),
    width=1200, height = 900)
p<-ggplot(plot_df) +
  geom_tile(data = plot_df_power, mapping = aes(x=datetime_tz,y = mid_height), 
            fill = "lightgreen", alpha = 0.2, height = bar_height) +
...
png(paste0("O:/PRIV/IRBData/AspireHealthTulare/Analysis/Air Quality Analysis/home_reports_plots/indoor_outdoor_pm25_byroom/",house,"/",room,"_indr__snippet_filter_plot.png"),
    width=900, height = 700)
...
no_power<-c("R26","R30","R56","R57", no_indoor_pm)
part_start_end$House_id<-str_sub(part_start_end$House_id,1,3)
part_start_end$start_date<-str_pad(part_start_end$start_date,6,"0",side = "left")  
wrong_power<-c("R05","R16")
...
png(paste0("O:/PRIV/IRBData/AspireHealthTulare/Analysis/Air Quality Analysis/home_reports_plots/indoor_outdoor_pm25_byroom/",house,"/week2_",room,"_indr_filter_plot.png"),
    width=1200, height = 900)
p<-ggplot(plot_df) +
  geom_tile(data = plot_df_power, mapping = aes(x=datetime_tz,y = mid_height), 
...
png(paste0("O:/PRIV/IRBData/AspireHealthTulare/Analysis/Air Quality Analysis/home_reports_plots/indoor_outdoor_pm25_byroom/",house,"/",
...
for(i in seq(room_id_list)) {
  ...
  if(room %in% no_indoor_pm) {
    enddate<-"2023-10-23 23:00:00 PDT"
  }else {
...
png(paste0("O:/PRIV/IRBData/AspireHealthTulare/Analysis/Air Quality Analysis/home_reports_plots/indoor_outdoor_pm25_byroom/",house,"/",room,"_wk2_indr_peak_plot.png"),
    width=1200, height = 900)
...
png(paste0("O:/PRIV/IRBData/AspireHealthTulare/Analysis/Air Quality Analysis/home_reports_plots/indoor_outdoor_pm25_byroom/",house,"/week2_",room,"_full_plot.png"),
...
## Snippet plot
## select time period with high indoor, in the evening
## need to correct how snippet is selected
# above_outdr<-plot_df$date[which(plot_df$pm2_5_indr_cor>plot_df$pm2_5_bluesky_cor & plot_df$power>20)]  #[round(length(which(plot_df$pm2_5_indr_cor>plot_df$pm2_5_bluesky_cor))/2,0)]
# plot_snippet<-subset(plot_df, format(as.Date(datetime_tz), "%m_%d")==format(as.Date(above_outdr),"%m_%d"))
# plot_snippet$time<-1:nrow(plot_snippet)
# plot_snippet<-subset(plot_snippet, time<=12)
# #power_snippet<-plot_df_power$date[round(nrow(plot_df_power)/2,0)]
# #plot_snippet<-subset(plot_df, format(as.Date(datetime_tz), "%m_%d")=="10_23")[c(1:12),]              ##format(as.Date(power_snippet),"%m_%d"))[c(1:12),]
# start_date<-min(plot_snippet$datetime_tz)
# end_date<-max(plot_snippet$datetime_tz)
# bar_height<-max(pmax(plot_snippet$pm2_5_indr_cor, plot_snippet$pm2_5_bluesky_cor, na.rm = T), na.rm=T) +5
# mid_height<-bar_height/2
# 
# png(paste0("O:/PRIV/IRBData/AspireHealthTulare/Analysis/Air Quality Analysis/home_reports_plots/indoor_outdoor_pm25_byroom/",house,"/snippet_",room,"_plot.png"),
...
avg_indr_evening_pm<- all_data %>%
  ...
  filter(datetime_tz>=as.POSIXct(format(as.Date(strptime("2023-10-07","%Y-%m-%d")),tz="America/Los_Angeles",usetz = TRUE),tz = "America/Los_Angeles")) %>%
  filter(Hour <= 5 | Hour >= 19) %>%
  group_by(treatment) %>%
...
for(i in seq(room_id_list)) {
  ...
  png(paste0("O:\\PRIV\\IRBData\\AspireHealthTulare\\Analysis\\Air Quality Analysis\\home_reports_plots\\avg_pm_barplots\\",room,"_avg_pm_barplot.png"),
...
missing_pm_homes<-c("H01","H19","H28","H31","H34")
house_id_list<-unique(all_data$house_id)

## households that do not have indoor pm logged for 2nd week of intervention
plot_week1_indr<-c("H01","H02","H07","H15","H30")
...
for(i in seq(house_id_list)) {
  ...
  plot_df_power<-subset(plot_df, date>="2023-10-08 00:00:00 UCT" & house_id ==house)
  # start_date<-"2023-10-08 00:00:00 UCT"
  # end_date<-"2023-10-21 02:00:00 UCT"
...
# png(paste0("O:/PRIV/IRBData/AspireHealthTulare/Analysis/Air Quality Analysis/home_reports_plots/indoor_outdoor_pm25_byroom/",house,"_week2_full_plot.png"),
#     width=1400, height = 900)  
...
for(i in seq(house_id_list)) {
  ...
  # png(paste0("O:\\PRIV\\IRBData\\AspireHealthTulare\\Analysis\\Air Quality Analysis\\home_reports_plots\\avg_pm_barplots\\",house,"_avg_pm_barplot.png"),
  #            width = 1000, height = 1000)
  #   print(p)
  #   dev.off()
...
for(i in seq(missing_pm_homes)) {
  ...
  png(paste0("O:\\PRIV\\IRBData\\AspireHealthTulare\\Analysis\\Air Quality Analysis\\home_reports_plots\\avg_pm_barplots\\",house,"_avg_pm_barplot_v2.png"),
             width = 1000, height = 1000)
    print(p)
    dev.off()
...
png(paste0("O:/PRIV/IRBData/AspireHealthTulare/Analysis/Air Quality Analysis/home_reports_plots/indoor_outdoor_pm25_byroom/",house,"_week2_nofilter_plot.png"),
    width=1400, height = 900)  
...
for(i in seq(house_id_list)) {
  ...
  png(paste0("O:\\PRIV\\IRBData\\AspireHealthTulare\\Analysis\\Air Quality Analysis\\home_reports_plots\\avg_pm_barplots\\",house,"_avg_pm_barplot_span.png"),
             width = 1000, height = 1000)
    print(p)
    dev.off()
}
...
for(i in seq(missing_pm_homes)) {
  ...
  png(paste0("O:\\PRIV\\IRBData\\AspireHealthTulare\\Analysis\\Air Quality Analysis\\home_reports_plots\\avg_pm_barplots\\",house,"_avg_pm_barplot_v2_span.png"),
             width = 1000, height = 1000)
    print(p)
    dev.off()
  Sys.setlocale("LC_TIME","English")  
...
png(paste0("O:/PRIV/IRBData/AspireHealthTulare/Analysis/Air Quality Analysis/home_reports_plots/indoor_outdoor_pm25_byroom/",house,"_week2_nofilter_plot_span.png"),
    width=1400, height = 900)  
...
png(paste0("O:/PRIV/IRBData/AspireHealthTulare/Analysis/Air Quality Analysis/home_reports_plots/indoor_outdoor_pm25_byroom/",house,"_week2_full_plot_span.png"),
    width=1400, height = 900)  
